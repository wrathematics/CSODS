...
.center[![:scale 50%](pics/25/party.png)]
...
].pull-right[![](pics/25/computer.jpg)]

---
# Memory Hierarchy
.center[![:scale 75%](pics/25/memory.png)]

---
# Cache
.center[![:scale 75%](pics/25/cache.png)]
...
].pull-right[.center[![:scale 75%](pics/25/array1.png)]]
...
* Col: `A[i, j] = A[i + m*j]`
* Row: `A[i, j] = A[i*n + j]`
].pull-right[.center[![:scale 75%](pics/25/array2.png)]]
