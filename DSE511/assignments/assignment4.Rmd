...
4. (10%) Suppose you are given a file `email_or_name.txt` that contains either a valid email address or a person's legal name, one per line. Write a shell script that tells you how many email addresses are in the file.

5. (10%) Write a shell script that lists the 3 largest files in the current working directory. The sizes should be in a human-readable format, and the files should be listed from largest to smallest. (Hint: `man du`).
